...
project = 'fdsim'
copyright = '2019, Joep van den Bogaert'
...
latex_documents = [
    (master_doc, 'fdsim.tex', 'fdsim Documentation',
     'Joep van den Bogaert', 'manual'),
]
...
man_pages = [
    (master_doc, 'fdsim', 'fdsim Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fdsim', 'fdsim Documentation',
     author, 'fdsim', 'One line description of project.',
     'Miscellaneous'),
]
